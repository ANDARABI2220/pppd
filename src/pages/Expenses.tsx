...
export default function Expenses() {
  ...
  async function loadExpenses() {
    const data = await db.expenses.orderBy('id').reverse().toArray();
    setExpenses(data);
  }
  ...
  const filtered = expenses.filter(e => {
    const matchesSearch = e.description.includes(searchQuery) || e.category.includes(searchQuery);
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={editingExpense ? 'ویرایش مصرف' : 'ثبت مصرف جدید'}
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="شرح مصرف را وارد کنید"
              required
            />
          </div>
          ...
          <div className="flex gap-3 justify-end pt-2">
            ...
            <button type="submit" className="btn-primary">
              {editingExpense ? 'بروزرسانی' : 'ذخیره'}
            </button>
          </div>
        </form>
      </Modal>
